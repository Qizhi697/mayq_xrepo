package("folly")
    ...
    add_deps("double-conversion", "gflags", "glog", "zlib", "fmt", "libunwind")
...
--     add_deps("boost", {configs = {context = true, filesystem = true, program_options = true, regex = true, system = true, thread = true}})
--     add_deps("libevent", {configs = {openssl = true}})
--     -- add_deps("double-conversion", "gflags", "libevent", "glog", "zlib", "fmt", "snappy", "libsodium", "bzip2", "zstd", "lz4", "lzma")
--     add_deps("double-conversion", "gflags", "glog", "zlib", "fmt", "snappy", "libsodium", "bzip2", "libunwind")
--     add_deps("lz4", "zstd", {optional = true})
--     if is_plat("linux") then
--         add_syslinks("pthread", "rt", "dl")
--     end
--     -- package:add("defines", "PCRE2_CODE_UNIT_WIDTH=" .. bitwidth)
--     on_install("windows|x64", "linux", "macosx", function (package)
--         -- package:add("defines", "SCM_TIMESTAMPING=37")
--         local configs = {"-DBUILD_TESTS=OFF",
--                          "-DCMAKE_DISABLE_FIND_PACKAGE_LibDwarf=ON",
--                          "-DCMAKE_DISABLE_FIND_PACKAGE_Libiberty=ON",
--                          "-DCMAKE_DISABLE_FIND_PACKAGE_LibAIO=ON",
